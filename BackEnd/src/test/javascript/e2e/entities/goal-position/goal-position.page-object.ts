...
export class GoalPositionComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-goal-position div table .btn-danger'));
  title = element.all(by.css('jhi-goal-position div h2#page-heading span')).first();
...
export class GoalPositionUpdatePage {
  pageTitle = element(by.id('jhi-goal-position-heading'));
...
export class GoalPositionDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-goalPosition-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-goalPosition'));
